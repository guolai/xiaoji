...
unsigned int default_css_len = 1024;
...
+ (DTCSSStylesheet *)defaultStyleSheet
{
	...
	@synchronized(self)
	{
		if (!defaultDTCSSStylesheet)
		{
            ...
            NSString *strResoucePath = [[NSBundle mainBundle] resourcePath];
            NSString *strPath = [NSString stringWithFormat:@"%@/default.css", strResoucePath];
